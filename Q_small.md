Smallest simulation in the quasisymmetric tree $Q$
================
Kalle Leppälä

This is a smaller version of [simulation_Q.md](simulation_Q.md) with the
number of independent allelic patterns reduced to 10,000.
...
save(tables, file = "Q_small.RData")
```

## Computing the $\Delta$-statistics

``` r
load(file = "Q_small.RData")
event <- character(0)
...
save(quasisymmetric, file = "Q_small_stats.RData")
```

## Plotting the results

``` r
load(file = "Q_small_stats.RData")
...
ggsave("Q_small.png", plot = figure, width = 160, height = 100, units = "mm")
print(figure)
```

![](Q_small_files/figure-gfm/plots-1.png)<!-- -->
