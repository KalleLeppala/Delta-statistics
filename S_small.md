Smallest simulation in the symmetric tree $S$
================
Kalle Leppälä

This is the smallest version of [S_big.md](S_big.md) with the number of
independent allelic patterns reduced to 10,000.
...
save(tables, file = "S_small.RData")
```
...
save(symmetric, file = "S_small_stats.RData")
```

## Plotting the results

``` r
load(file = "S_small_stats.RData")
...
ggsave("S_small.png", plot = figure, width = 160, height = 80, units = "mm")
print(figure)
```

![](S_small_files/figure-gfm/plots-1.png)<!-- -->
