---  
title: "Running the $D$~FOIL~-statistics"
...
Using the simulated created in [S_big.md](S_big.md) with 1,000,000 independent allelic patterns on 32 admixture scenarios in tree $S$, we calculate a data frame of $D_\text{FOIL}$-statistics [@pease2015detection].
Note that because they matter for the $\Delta$-statistics, we exceptionally include the scenarios $1 \rightarrow 5$, $2 \rightarrow 5$, $3 \rightarrow 5$ and $4 \rightarrow 5$ even though they're expected to produce a zero signal.

```{r computing_the_delta-statistics_big}
...
Now using the simulated created in [S_medium.md](S_medium.md) with 100,000 independent allelic patterns on 32 admixture scenarios in tree $S$.

```{r computing_the_delta-statistics_medium}
...
Now using the simulated created in [S_small.md](S_small.md) with 10,000 independent allelic patterns on 32 admixture scenarios in tree $S$.

```{r computing_the_delta-statistics_small}
